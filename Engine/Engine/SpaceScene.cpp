...
void SpaceScene::initialize() /*override*/
{
	...
	// int earthHeightTexID = TextureManager::getInstance()->setTexture2D(1024, 1024, GL_UNSIGNED_BYTE, 3, noiseTextureData);
	// 
	...
	// 
	// std::shared_ptr<Earth> earth = std::make_shared<Earth>("Earth", glm::vec3(0.f, 0.f, 0.f), 10.f, earthProgram, earthTexID, "tex");
